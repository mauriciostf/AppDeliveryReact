...
const categories: Category[] = [
  ...
  { name: 'Shoarma', image: 'https://s2-receitas.glbimg.com/Xesf11hU86tvrMAh8L5Rm_ER-tQ=/0x0:1280x853/924x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_e84042ef78cb4708aeebdf1c68c6cbd6/internal_photos/bs/2020/7/7/9hcKcRQf2Al4TplEJCYw/shawarma.jpeg' },
];
...
// Define o componente funcional `Categories`.
  ...
  // Função chamada quando o usuário clica em uma categoria.
    ...
    } else if (name ==='ShoarmaSL!'){
      router.push('/(tabs)/screens/Shoarma2');
    }
  };
